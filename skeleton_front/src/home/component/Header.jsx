    ...
    <div>
      ...
      <nav className='navbar navbar-default navbar-trans navbar-expand-lg fixed-top'>
        <div className='container'>
          ...
          <Link className='navbar-brand text-brand' href='index.html'>
          ...
          <div className='navbar-collapse collapse justify-content-center' id='navbarDefault'>
            <ul className='navbar-nav'>
              ...
              <li className='nav-item'>
                <Link className='nav-link ' to='/board/boardList'>
                  Board
                </Link>
              </li>
              ...
              <li className='nav-item dropdown'>
                ...
                <div className='dropdown-menu'>
                  <Link className='dropdown-item ' href='property-single.html'>
                    Property Single
                  </Link>
                  <Link className='dropdown-item ' href='blog-single.html'>
                    Blog Single
                  </Link>
                  <Link className='dropdown-item ' href='agents-grid.html'>
                    Agents Grid
                  </Link>
                  <Link className='dropdown-item ' href='agent-single.html'>
                    Agent Single
                  </Link>
                </div>
              </li>
