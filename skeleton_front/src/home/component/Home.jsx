...
const Home = () => {
  return (
    <div>
      ...
      - html 주석..
      - html 은 single tag 를 혀용하지만.. jsx 는 xml 문법이다. single tag 허용하지 않는다..
      - a => Link
      - class => className
              ...
              <div className='col-md-4'>
                <div className='card-box-c foo'>
                  ...
                  <div className='card-footer-c'>
                    <Link href='#' className='link-c link-icon'>
                      Read more
                ...
                <div className='card-box-c foo'>
                  ...
                  <div className='card-body-c'>
                    <p className='content-c'>
                      ...
                      blandit. Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a.
                    </p>
                  </div>
                  <div className='card-footer-c'>
                    <Link href='#' className='link-c link-icon'>
                    ...
                    <div className='card-header-d'>
                      <div className='card-title-d align-self-center'>
                        <h3 className='title-d'>
                          <Link href='agent-single.html' className='link-two'>
                            Margaret Sotillo
                            <br /> Escala
                          </Link>
                        </h3>
                    ...
                    <div className='row'>
                      ...
                      <div className='col-sm-12 col-md-6'>
                        ...
                        <div className='testimonial-author-box'>
                          <img
                            src='images/mini-testimonial-1.jpg'
                            alt=''
