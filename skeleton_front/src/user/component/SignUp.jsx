                ...
                <div className='row'>
                  ...
                  <div className='col-md-6 col-lg-5 section-md-t3'>
                    ...
                    <p className='color-text-a'>
                      Mauris blandit aliquet elit, eget tincidunt nibh pulvinar a. Vivamus magna
                      justo, lacinia eget consectetur sed, convallis at tellus. Praesent sapien
                    ...
                    <p className='color-text-a'>
                      ...
                      a. Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus.
                    </p>
                  </div>
                </div>
              </div>
